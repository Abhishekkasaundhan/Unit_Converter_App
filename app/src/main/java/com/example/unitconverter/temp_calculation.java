...
public class temp_calculation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_temp_calculation);
        ...
        tv_fU.setText(values[0]);
        tv_TU.setText(values[0]);
        ...
        cv_C.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tempInput.equals("") || tempInput == null) {
                    ...
                    if (tv_fU.getText().toString().equals(values[0])) {
                        if (tv_TU.getText().toString().equals(values[0])) {
                            et_TU.setText(tempInput);
                        } else if (tv_TU.getText().toString().equals(values[1])) {
                            et_TU.setText(celciusToFarenheit(Double.parseDouble(tempInput)));
                        } else if (tv_TU.getText().toString().equals(values[2])) {
                            et_TU.setText(celciusToKelvin(Double.parseDouble(tempInput)));
                        } else if (tv_TU.getText().toString().equals(values[3])) {
                            et_TU.setText(celciusToRankine(Double.parseDouble(tempInput)));
                        } else if (tv_TU.getText().toString().equals(values[4])) {
                            et_TU.setText(celciusToNewton(Double.parseDouble(tempInput)));
                        } else if (tv_TU.getText().toString().equals(values[5])) {
                            et_TU.setText(celciusToDelisle(Double.parseDouble(tempInput)));
                        }
                    } else if (tv_fU.getText().toString().equals(values[1])) {
                        if (tv_TU.getText().toString().equals(values[0])) {
                    ...
                    } else if (tv_fU.getText().toString().equals(values[2])) {
                        if (tv_TU.getText().toString().equals(values[0])) {
                    ...
                    } else if (tv_fU.getText().toString().equals(values[3])) {
                        if (tv_TU.getText().toString().equals(values[0])) {
                    ...
                    } else if (tv_fU.getText().toString().equals(values[4])) {
                        if (tv_TU.getText().toString().equals(values[0])) {
                    ...
                    } else if (tv_fU.getText().toString().equals(values[5])) {
                        if (tv_TU.getText().toString().equals(values[0])) {
        ...
        cv_TU.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(temp_calculation.this);
